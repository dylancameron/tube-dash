...
const Drawer = forwardRef(DrawerFn) as <TTag extends ElementType = "div">(
	props: DrawerProps<TTag> & { ref?: Ref<HTMLDivElement> }
) => JSX.Element;

// Define the DrawerTitle's props
export type DrawerTitleProps<TTag extends ElementType = "h2"> = {
	children: React.ReactNode;
} & Omit<React.ComponentPropsWithoutRef<TTag>, "children">;

// DrawerTitle function component
function TitleFn<TTag extends ElementType = "h2">(
...
const DrawerTitle = forwardRef(TitleFn) as <TTag extends ElementType = "h2">(
	props: DrawerTitleProps<TTag> & { ref?: Ref<HTMLHeadingElement> }
) => JSX.Element;
